      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <Button variant="outline" size="lg" className="mt-4 rounded-full">Saiba mais &rarr;</Button>
          </div>
        </div>
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit) => (
            <Card key={benefit.title} className="text-center border hover:shadow-xl transition-shadow duration-300">
              <CardHeader>
